        ...
        buttonProses.setOnClickListener {
            if (TextDarik.length()==0){
             ...
             if (jawaban == keteranganbetul){
                 val toast = Toast.makeText(this,"12 Darik Aflah A.A XI RPL 3", Toast.LENGTH_SHORT)
                 toast.show()
                 val keterangan = "12 Darik Aflah A.A XI RPL 3"
